...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br p-4">
      <Card className="w-full max-w-md relative border-[#D2DCB6]">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center text-[#F1F3E0]">
            ...
            <TabsContent value="login">
              <form onSubmit={handleLogin} className="space-y-4 w-full">
                <div className="space-y-2">
                  ...
                  <Input id="login-email" type="email" placeholder="name@company.com" value={loginData.email} onChange={(e) => setLoginData({ ...loginData, email: e.target.value as any })} required className="border-[#D2DCB6]  focus:ring-[#778873] min-w-90" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="login-password">Password</Label>
                  <Input id="login-password" type="password" placeholder="••••••••" value={loginData.password} onChange={(e) => setLoginData({ ...loginData, password: e.target.value as any })} required className="border-[#D2DCB6]  focus:ring-[#778873] min-w-90" />
                </div>
            ...
            <TabsContent value="signup">
              <form onSubmit={handleSignup} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="signup-name"  placeholder="John Doe" value={signupData.name} onChange={(e) => setSignupData({ ...signupData, name: e.target.value as any })} required className="border-[#D2DCB6]  focus:ring-[#778873] min-w-90" />
                </div>
